            ...
            <>
                <div className='coin'>
                    ...
                    <div className="coinInfo">
                        <ul>
                            <li className='text-capitalize'>crypto market rank</li>
                            <li>{coinData.market_cap_rank}</li>
                        </ul>
                        <ul>
                            <li className='text-capitalize'>current price</li>
                            <li>{currency.symbol}{coinData.market_data.current_price[currency.name].toLocaleString()}</li>
                        </ul>
                        <ul>
                            <li className='text-capitalize'>market cap</li>
                            <li>{currency.symbol}{coinData.market_data.market_cap[currency.name].toLocaleString()}</li>
                        </ul>
                        <ul>
                            <li className='text-capitalize'>24 hour high</li>
                            <li>{currency.symbol}{coinData.market_data.high_24h[currency.name].toLocaleString()}</li>
                        </ul>
                        <ul>
                            <li className='text-capitalize'>24 hour low</li>
